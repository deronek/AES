...
APP_MANAGER = AppManager.APP_MANAGER_READY


def draw_app_manager():
    ...
    for index, item in enumerate(AppManager):
        app_manager.blit(FONT_LINES.render(item.name, False, WHITE if item is APP_MANAGER else DARK_GRAY), (0, 80 + 50 * index))
